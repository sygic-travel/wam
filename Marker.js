	...
	render() {
		return (
			<View style={{
				...
				{ this.props.markerSize === 'big' &&
					<View style={{
						backgroundColor: '#000',
						position: 'absolute',
						bottom: sizes[this.props.markerSize] + 2,
						left: (sizes[this.props.markerSize] / 2) - 25,
						width: 50,
						display: 'flex',
						alignContent: 'center'
					}}>
				...
				<TouchableHighlight onPress={() => this.props.onMarkerPress(this.props.place.id)}>
					<View style={getMarkerStyles(this.props.offset, this.props.markerSize, this.state.markerColor)}>
						{ this.props.place.thumbnailUrl && this.props.markerSize === 'big' ? (
							<Image
								source={{
									uri: this.props.place.thumbnailUrl
								}}
								style={{
							...
							<Image
								...
								style={{
									width: sizes[this.props.markerSize],
									height: sizes[this.props.markerSize],
									zIndex: 10
								}}>
							</Image>
						)}
